...
## BTW 2017 
Yule's K: more complex formula based on TTR but adjusting for text length, changes finding $\rightarrow$ AfD loses (shorter text)!
```{r lexdiv2, echo=TRUE}
...
- Higher values imply less readability 
```{r read1, echo=TRUE}
